...
ArthJAX is at **v1.2.0** — policy counterfactuals, Monte Carlo stress paths, scenarios, benchmarks, CI, and a [live Kaggle demo](https://www.kaggle.com/code/varunraosfanlkan/arthjax-gpu-macro-abm-world-model).
